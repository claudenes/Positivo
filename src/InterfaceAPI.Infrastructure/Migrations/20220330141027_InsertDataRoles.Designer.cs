...
namespace Positivo.InterfaceAPI.Infrastructure.Migrations
{
    ...
    [Migration("20220330141027_InsertDataRoles")]
    partial class InsertDataRoles
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Positivo.InterfaceAPI.Domain.Alunos", b =>
                {
                    ...
                    b.Property<long?>("NiveisEnsinoId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("UnidadesFisicasId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("NiveisEnsinoId");

                    b.HasIndex("UnidadesFisicasId");
            ...
            modelBuilder.Entity("Positivo.InterfaceAPI.Domain.Funcionarios", b =>
                {
                    ...
                    b.Property<decimal?>("Funcionario")
                        .IsRequired()
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Positivo.InterfaceAPI.Domain.Alunos", b =>
                {
                    b.HasOne("Positivo.InterfaceAPI.Domain.NiveisEnsino", "NiveisEnsino")
                        .WithMany()
                        .HasForeignKey("NiveisEnsinoId");

                    b.HasOne("Positivo.InterfaceAPI.Domain.UnidadesFisicas", "UnidadesFisicas")
                        .WithMany()
                        .HasForeignKey("UnidadesFisicasId");

                    b.Navigation("NiveisEnsino");
