...
{
    public class TurmasCreateCommandHandler : IRequestHandler<TurmasCreateCommand, Turmas>
    {
        private ITurmasRepository _turmasRepository;
        private readonly IMapper _mapper;

        public TurmasCreateCommandHandler(
            IMapper mapper,
        ...
        public async Task<Turmas> Handle(TurmasCreateCommand command, CancellationToken cancellationToken)
        {
