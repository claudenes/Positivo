using System;
using Positivo.InterfaceAPI.Infrastructure.Configuration;
using System.IdentityModel.Tokens.Jwt;
using System.Text;
using Positivo.InterfaceAPI.Infrastructure.Data;
using Positivo.InterfaceAPI.Domain;
using Positivo.InterfaceAPI.Security;
using Positivo.InterfaceAPI.Security.Jwt;
using Positivo.InterfaceAPI.Domain.Services;
...
using AuthenticationService = Positivo.InterfaceAPI.Domain.Services.AuthenticationService;
using IAuthenticationService = Positivo.InterfaceAPI.Domain.Services.Interfaces.IAuthenticationService;
